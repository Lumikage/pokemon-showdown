export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	pokestarufopropu2: {
		...
		name: "Twigler",
		types: ["Grass"],
		baseStats: {hp: 50, atk: 65, def: 45, spa: 45, spd: 45, spe: 60},
		abilities: {0: "Overgrow", H: "Revitalize"},
		heightm: 0.5,
		weightkg: 6,
		evos: ["Stagrove"],
		eggGroups: ["Grass", "Field"],
	...
	stagrove: {
		...
		name: "Stagrove",
		types: ["Grass"],
		baseStats: {hp: 65, atk: 75, def: 75, spa: 50, spd: 55, spe: 90},
		abilities: {0: "Overgrow", H: "Revitalize"},
		heightm: 1.2,
		weightkg: 30,
		prevo: "Twigler",
	...
	gallantler: {
		...
		name: "Gallantler",
		types: ["Grass", "Dark"],
		baseStats: {hp: 85, atk: 95, def: 95, spa: 54, spd: 75, spe: 126},
		abilities: {0: "Overgrow", H: "Revitalize"},
		heightm: 2.0,
		weightkg: 52,
		prevo: "Stagrove",
	...
	pyrull: {
		...
		name: "Pyrull",
		types: ["Fire"],
		baseStats: {hp: 65, atk: 60, def: 55, spa: 50, spd: 50, spe: 40},
		abilities: {0: "Blaze", H: "Rumination"},
		heightm: 0.7,
		weightkg: 10,
		evos: ["Blazox"],
		eggGroups: ["Field", "Human-Like"],
	...
	blazox: {
		...
		name: "Blazox",
		types: ["Fire"],
		baseStats: {hp: 80, atk: 65, def: 65, spa: 75, spd: 65, spe: 60},
		abilities: {0: "Blaze", H: "Rumination"},
		heightm: 1.1,
		weightkg: 34,
		prevo: "Pyrull",
	...
	zenferno: {
		...
		name: "Zenferno",
		types: ["Fire", "Psychic"],
		baseStats: {hp: 94, atk: 71, def: 88, spa: 104, spd: 88, spe: 85},
		abilities: {0: "Blaze", H: "Rumination"},
		heightm: 1.9,
		weightkg: 74,
		prevo: "Blazox",
	...
	snailimp: {
		...
		name: "Snailimp",
		types: ["Water"],
		baseStats: {hp: 60, atk: 45, def: 55, spa: 65, spd: 55, spe: 25},
		abilities: {0: "Torrent", H: "Shellshock"},
		heightm: 0.5,
		weightkg: 13,
		evos: ["Wallusk"],
		eggGroups: ["Water 1", "Bug"],
	...
	wallusk: {
		...
		name: "Wallusk",
		types: ["Water"],
		baseStats: {hp: 88, atk: 80, def: 90, spa: 50, spd: 70, spe: 32},
		abilities: {0: "Torrent", H: "Shellshock"},
		heightm: 0.8,
		weightkg: 44,
		prevo: "Snailimp",
	...
	conchampion: {
		...
		name: "Conchampion",
		types: ["Water", "Fighting"],
		baseStats: {hp: 100, atk: 116, def: 120, spa: 60, spd: 80, spe: 54},
		abilities: {0: "Torrent", H: "Shellshock"},
		heightm: 2.0,
		weightkg: 156,
		prevo: "Wallusk",
	...
	lialynx: {
		...
		name: "Lialynx",
		types: ["Ground", "Normal"],
		baseStats: {hp: 50, atk: 55, def: 40, spa: 35, spd: 40, spe: 55},
		abilities: {0: "Stakeout", 1: "Sand Veil", H: "Hustle"},
		heightm: 0.4,
		weightkg: 8,
		evos: ["Lyncarix"],
		eggGroups: ["Field"],
	...
	lyncarix: {
		...
		name: "Lyncarix",
		types: ["Ground", "Normal"],
		baseStats: {hp: 70, atk: 75, def: 60, spa: 55, spd: 60, spe: 75},
		abilities: {0: "Stakeout", 1: "Sand Veil", H: "Hustle"},
		heightm: 0.8,
		weightkg: 24,
		prevo: "Lialynx",
		evos: ["Excavalynx", "Lyncounce"],
		eggGroups: ["Field"],
	},
	excavalynx: {
		num: -4012,
		...
		types: ["Ground", "Dark"],
		gender: "M",
		baseStats: {hp: 84, atk: 115, def: 75, spa: 68, spd: 70, spe: 108},
		abilities: {0: "Stakeout", 1: "Sand Rush", H: "Strong Jaw"},
		heightm: 1.3,
		weightkg: 82,
		prevo: "Lyncarix",
		eggGroups: ["Field"],
	...
	lyncounce: {
		...
		types: ["Ground", "Normal"],
		gender: "F",
		baseStats: {hp: 92, atk: 100, def: 75, spa: 68, spd: 70, spe: 115},
		abilities: {0: "Stakeout", 1: "Sand Force", H: "Tough Claws"},
		heightm: 1.3,
		weightkg: 64,
		prevo: "Lyncarix",
		eggGroups: ["Field"],
	...
	winkit: {
		...
		name: "Winkit",
		types: ["Electric", "Normal"],
		baseStats: {hp: 45, atk: 35, def: 50, spa: 55, spd: 50, spe: 45},
		abilities: {0: "Lightning Rod", 1: "Static", H: "Friend Guard"},
		heightm: 0.4,
		weightkg: 3,
		evos: ["Tawnimer"],
		eggGroups: ["Field"],
	...
	tawnimer: {
		...
		name: "Tawnimer",
		types: ["Electric", "Normal"],
		baseStats: {hp: 70, atk: 51, def: 55, spa: 95, spd: 71, spe: 91},
		abilities: {0: "Lighting Rod", 1: "Illuminate", H: "Victory Star"},
		heightm: 0.8,
		weightkg: 12,
		prevo: "Winkit",
		eggGroups: ["Field"],
	...
	amureile: {
		...
		types: ["Dragon", "Fairy"],
		gender: "F",
		baseStats: {hp: 50, atk: 35, def: 40, spa: 65, spd: 55, spe: 55},
		abilities: {0: "Serene Grace", 1: "Cute Charm", H: "Wonder Skin"},
		heightm: 0.6,
		weightkg: 6,
		evos: ["Impedraile"],
	...
	impedraile: {
		...
		types: ["Dragon", "Fairy"],
		gender: "F",
		baseStats: {hp: 81, atk: 71, def: 84, spa: 104, spd: 90, spe: 85},
		abilities: {0: "Serene Grace", 1: "Queenly Majesty", H: "Wonder Skin"},
		heightm: 1.5,
		weightkg: 38,
		prevo: "Amureile",
		eggGroups: ["Dragon", "Field"],
	...
	raptarix: {
		...
		name: "Raptarix",
		types: ["Dark", "Flying"],
		baseStats: {hp: 50, atk: 54, def: 52, spa: 54, spd: 40, spe: 70},
		abilities: {0: "Prankster", 1: "Pickpocket", H: "Unnerve"},
		heightm: 0.4,
		weightkg: 10,
		evos: ["Gustigrave"],
		eggGroups: ["Flying"],
	...
	gustigrave: {
		...
		name: "Gustigrave",
		types: ["Dark", "Flying"],
		baseStats: {hp: 100, atk: 64, def: 100, spa: 82, spd: 80, spe: 64},
		abilities: {0: "Prankster", 1: "Pickpocket", H: "Intimidate"},
		heightm: 1.0,
		weightkg: 22,
		prevo: "Raptarix",
		eggGroups: ["Flying"],
	...
	airesquall: {
		...
		name: "Airesquall",
		types: ["Fighting", "Flying"],
		baseStats: {hp: 45, atk: 70, def: 45, spa: 35, spd: 35, spe: 90},
		abilities: {0: "Reckless", 1: "Justified", H: "Unnerve"},
		heightm: 0.2,
		weightkg: 7,
		evos: ["Zephyrath"],
		eggGroups: ["Flying"],
	...
	zephyrath: {
		...
		name: "Zephyrath",
		types: ["Fighting", "Flying"],
		baseStats: {hp: 78, atk: 115, def: 75, spa: 48, spd: 53, spe: 116},
		abilities: {0: "Reckless", 1: "Justified", H: "Intimidate"},
		heightm: 1.6,
		weightkg: 42,
		prevo: "Airesquall",
		eggGroups: ["Flying"],
	...
	larvant: {
		...
		name: "Larvant",
		types: ["Bug", "Fire"],
		baseStats: {hp: 40, atk: 20, def: 25, spa: 40, spd: 35, spe: 30},
		abilities: {0: "Flash Fire", H: "Keen Eye"},
		heightm: 0.4,
		weightkg: 0.8,
		evos: ["Chrysigna"],
		eggGroups: ["Bug"],
	...
	chrysigna: {
		...
		name: "Chrysigna",
		types: ["Bug", "Fire"],
		baseStats: {hp: 60, atk: 36, def: 76, spa: 70, spd: 70, spe: 30},
		abilities: {0: "Flash Fire", H: "Shield Dust"},
		heightm: 0.7,
		weightkg: 10,
		prevo: "Larvant",
		evos: ["Pyromite"],
	...
	pyromite: {
		...
		name: "Pyromite",
		types: ["Bug", "Fire"],
		baseStats: {hp: 80, atk: 72, def: 76, spa: 100, spd: 70, spe: 92},
		abilities: {0: "Flash Fire", H: "Compound Eyes"},
		heightm: 1.2,
		weightkg: 19,
		prevo: "Chrysigna",
		eggGroups: ["Bug"],
	...
	hopivo: {
		...
		name: "Hopivo",
		types: ["Grass"],
		baseStats: {hp: 65, atk: 75, def: 60, spa: 40, spd: 55, spe: 40},
		abilities: {0: "Reckless", 1: "Vital Spirit", H: "Grass Pelt"},
		heightm: 0.7,
		weightkg: 17,
		evos: ["Lapinorde"],
		eggGroups: ["Field"],
	...
	lapinorde: {
		...
		name: "Lapinorde",
		types: ["Grass", "Rock"],
		baseStats: {hp: 80, atk: 116, def: 78, spa: 62, spd: 72, spe: 86},
		abilities: {0: "Rock Head", 1: "Cursed Body", H: "Grass Pelt"},
		heightm: 1.6,
		weightkg: 62,
		prevo: "Hopivo",
		eggGroups: ["Field"],
	...
	agulas: {
		...
		name: "Agulas",
		types: ["Water"],
		baseStats: {hp: 45, atk: 50, def: 45, spa: 50, spd: 45, spe: 55},
	...
	aquellas: {
		...
		name: "Aquellas",
		types: ["Water", "Ice"],
		baseStats: {hp: 75, atk: 54, def: 74, spa: 74, spd: 68, spe: 65},
		abilities: {0: "Swift Swim", 1: "Slush Rush", H: "Ice Body"},
		heightm: 0.9,
		weightkg: 22,
		prevo: "Agulas",
	...
	ursalugas: {
		...
		name: "Arsalugas",
		types: ["Water", "Ice"],
		baseStats: {hp: 100, atk: 68, def: 106, spa: 83, spd: 98, spe: 75},
		abilities: {0: "Swift Swim", 1: "Slush Rush", H: "Refrigerate"},
		heightm: 1.2,
		weightkg: 78,
		prevo: "Aqeullas",
		eggGroups: ["Water 1", "Dragon"],
	...
	argonovus: {
		...
		name: "Argonovus",
		types: ["Water"],
		baseStats: {hp: 110, atk: 76, def: 114, spa: 52, spd: 62, spe: 16},
		abilities: {0: "Innards Out", H: "Regenerator"},
		heightm: 0.1,
		weightkg: 9,
		eggGroups: ["Water 3"],
	},
	wrigglite: {
		...
		name: "Wrigglite",
		types: ["Ground", "Bug"],
		baseStats: {hp: 30, atk: 35, def: 40, spa: 20, spd: 40, spe: 35},
		abilities: {0: "Own Tempo", H: "Arena Trap"},
		heightm: 0.4,
		weightkg: 4,
		evos: ["Squirmlurm"],
		eggGroups: ["Monster", "Dragon"],
	...
	squirmlurm: {
		...
		name: "Squirmlurm",
		types: ["Ground", "Poison"],
		baseStats: {hp: 55, atk: 65, def: 70, spa: 45, spd: 70, spe: 55},
		abilities: {0: "Own Tempo", H: "Arena Trap"},
		heightm: 0.5,
		weightkg: 7,
		prevo: "Wrigglite",
	...
	entogoon: {
		...
		name: "Entogoon",
		types: ["Ground", "Poison"],
		baseStats: {hp: 70, atk: 95, def: 98, spa: 65, spd: 98, spe: 89},
		abilities: {0: "Earthen Clamp", H: "Arena Trap"},
		heightm: 5.2,
		weightkg: 172,
		prevo: "Squirmlurm",
		eggGroups: ["Monster", "Dragon"],
	...
	glenron: {
		...
		name: "Glenron",
		types: ["Steel"],
		baseStats: {hp: 45, atk: 50, def: 55, spa: 50, spd: 55, spe: 55},
		abilities: {0: "Heatproof", H: "Rattled"},
		heightm: 0.4,
		weightkg: 15,
		evos: ["Tritank"],
		eggGroups: ["Monster", "Mineral"],
	...
	tritank: {
		...
		name: "Tritank",
		types: ["Steel"],
		baseStats: {hp: 60, atk: 65, def: 80, spa: 65, spd: 80, spe: 60},
	...
	rapdreiven: {
		...
		name: "Rapdreiven",
		types: ["Steel", "Fire"],
		baseStats: {hp: 71, atk: 80, def: 121, spa: 80, spd: 93, spe: 75},
		abilities: {0: "Flash Fire", H: "Speed Boost"},
		heightm: 2.0,
		weightkg: 187,
		prevo: "Tritank",
	...
	skiddoalfar: {
		...
		forme: "Alfar",
		types: ["Fighting", "Ice"],
		baseStats: {hp: 60, atk: 70, def: 63, spa: 50, spd: 57, spe: 50},
		abilities: {0: "Slush Rush", 1: "Scrappy", H: "Overcoat"},
		heightm: 0.8,
		weightkg: 35,
		evos: ["Gogoat-Alfar"],
		eggGroups: ["Field"],
	...
	gogoatalfar: {
		...
		forme: "Alfar",
		types: ["Fighting", "Ice"],
		baseStats: {hp: 107, atk: 120, def: 97, spa: 71, spd: 83, spe: 58},
		abilities: {0: "Slush Rush", 1: "Scrappy", H: "Overcoat"},
		heightm: 1.7,
		weightkg: 100,
		prevo: "Skiddo-Alfar",
	...
	woolooalfar: {
		...
		forme: "Alfar",
		types: ["Steel"],
		baseStats: {hp: 45, atk: 45, def: 55, spa: 40, spd: 45, spe: 40},
		abilities: {0: "Static", 1: "Filter", H: "Iron Barbs"},
		heightm: 0.6,
		weightkg: 10,
		evos: ["Dubwool-Alfar"],
		eggGroups: ["Field"],
	...
	dubwoolalfar: {
		...
		forme: "Alfar",
		types: ["Steel", "Electric"],
		baseStats: {hp: 88, atk: 85, def: 95, spa: 60, spd: 80, spe: 72},
		abilities: {0: "Static", 1: "Filter", H: "Galvanize"},
		heightm: 1.3,
		weightkg: 46,
		prevo: "Wooloo-Alfar",
		eggGroups: ["Field"],
	...
	chatotalfar: {
		...
		forme: "Alfar",
		types: ["Fairy", "Flying"],
		baseStats: {hp: 66, atk: 41, def: 41, spa: 135, spd: 43, spe: 85},
		abilities: {0: "Unnerve", 1: "Rivalry", H: "Sonorous"},
		heightm: 0.5,
		weightkg: 2,
		eggGroups: ["Flying"],
	},
